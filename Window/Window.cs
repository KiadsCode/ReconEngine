...
namespace Recon
{
    namespace Window
    {
        ...
        public class Window : ObjectBase
        {
            ...
            [DllImport("recon-window-con.dll", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
            static extern Vector2UI sfWindow_getSize(IntPtr CPointer);

            [DllImport("recon-window-con.dll", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
            static extern void sfWindow_setSize(IntPtr CPointer, Vector2UI size);
