...
namespace Recon
{
    namespace Graphics
    {
        ...
        public class EngineWindow : Recon.Window.Window, RenderTarget
        {
            ...
            public void SetFixedFrameRate(uint nrate)
            {
                fixedFrameRate = nrate;
            }

            internal int framerateLimit;
            private double fixedFrameRate = 60;
            public double FIXEDFPS
            {
                get
                {
            ...
            [DllImport("recon-graphics-con.dll", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
            static extern Vector2UI sfRenderWindow_getSize(IntPtr CPointer);

            [DllImport("recon-graphics-con.dll", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
            static extern void sfRenderWindow_setSize(IntPtr CPointer, Vector2UI size);
