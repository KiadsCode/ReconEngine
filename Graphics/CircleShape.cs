...
namespace Recon
{
    namespace Graphics
    {
        ...
        public class CircleShape : Shape
        {
            ...
            {
                float angle = (float)(index * 2 * System.Math.PI / myPointCount - System.Math.PI / 2);
                float x = (float)System.Math.Cos(angle) * myRadius;
                float y = (float)System.Math.Sin(angle) * myRadius;
