    ...
    namespace Graphics
    {
        ...
        public struct IntRect
        {
            ...
            public bool Intersects(IntRect rect)
            {
                ...
                int left   = System.Math.Max(Left,         rect.Left);
                int top    = System.Math.Max(Top,          rect.Top);
                int right  = System.Math.Min(Left + Width, rect.Left + rect.Width);
                int bottom = System.Math.Min(Top + Height, rect.Top + rect.Height);
        ...
        public struct FloatRect
        {
            ...
            {
                // Compute the intersection boundaries
                float left   = System.Math.Max(Left,         rect.Left);
                float top    = System.Math.Max(Top,          rect.Top);
                float right  = System.Math.Min(Left + Width, rect.Left + rect.Width);
                float bottom = System.Math.Min(Top + Height, rect.Top + rect.Height);
