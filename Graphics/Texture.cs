...
namespace Recon
{
    namespace Graphics
    {
        ...
        public class Texture : ObjectBase
        {
            ...
            ////////////////////////////////////////////////////////////
            public void Update(Recon.Window.Window window)
            {
                Update(window, 0, 0);
            }
            ...
            /// <param name="y">Y offset in the texture where to copy the source pixels</param>
            ////////////////////////////////////////////////////////////
            public void Update(Recon.Window.Window window, uint x, uint y)
            {
            ...
            /// <param name="window">Render-window to copy to the texture</param>
             ////////////////////////////////////////////////////////////
            public void Update(EngineWindow window)
            {
                Update(window, 0, 0);
            }
            ...
            /// <param name="y">Y offset in the texture where to copy the source pixels</param>
            ////////////////////////////////////////////////////////////
            public void Update(EngineWindow window, uint x, uint y)
            {
            ...
            [DllImport("recon-graphics-con.dll", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
            static extern Vector2UI sfTexture_getSize(IntPtr texture);
